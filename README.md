...
I am a software engineer focused on Python, ML pipelines, and custom LLM engineering. When I'm off the clock, I channel my energy into building practical tools for the self-hosted and Docker ecosystem.

### 🚀 What I'm Up To
*   **Currently working on:** Building open-source tools to simplify and streamline my personal tech infrastructure.
*   **Currently learning:** Mastering **LangGraph** to build sophisticated, fine-grained AI agents powered entirely by self-hosted local models.
*   **Looking for help with:** Connecting with other self-hosting enthusiasts to collaborate, test, and improve my projects.
